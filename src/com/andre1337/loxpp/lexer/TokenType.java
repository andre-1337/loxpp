...
public enum TokenType {
  ...
  WITH, TRAIT, THROW, ENUM, IS,
  ABSTRACT, TYPEOF, LAZY, USING,
  CATCH, FINALLY, NAMESPACE, FROM,
  TRY, UNION, MATCH, IMPL, ASYNC,
  AWAIT, PRIVATE, EXPORT, NEW, FIELD,

  // Special tokens
  EOF, INTERPOLATION_START, INTERPOLATION_END, STRING_PART,
}
